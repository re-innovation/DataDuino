...
const char headers[] PROGMEM = "Ref,Date,Time,Pulses,Temp1(C),Temp2(C),Temp3(C),Temp4(C),D7,D8,D9,A0,A1,A2,A3";  // Headers for the top of the file
...
void loop()
{
  ...
  if(writedataflag==HIGH)
  {
    ...
    dataString = ref1-'0'; //String(housenumber);
    dataString += ref2-'0';
    dataString += comma;
    dataString += newdate;
    dataString += comma;
